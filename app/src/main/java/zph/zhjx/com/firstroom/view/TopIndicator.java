package zph.zhjx.com.firstroom.view;
...
public class TopIndicator extends LinearLayout {
    ...
    private void init(Context context) {
        ...
        mUnderLineWidth = mScreenWidth / mLabels.length-50;

        mUnderLine = new View(context);
        mUnderLine.setBackgroundColor(Color.parseColor("#d4020d"));
        ...
        for (int i = 0; i < size; i++) {
           ...
           // 初始化 底部菜单选中状态,默认第一个选中
            if (i==0) {
                ...
                itemName.setTextColor(Color.parseColor("#d4020d"));
    ...
    public void setTabsDisplay(Context context, int index) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if ((Integer) (checkedTextView.getTag()) == index) {
                ...
                checkedTextView.setTextColor(Color.parseColor("#d4020d"));
            } else {
